...
public class SearchbarProveedor extends JPanel{
    public SearchbarProveedor(DefaultTableModel modelo){
    ...
    public static void Buscar(String filtro,DefaultTableModel modelo){
        ...
        if(modelo.getRowCount() == 0){
            JOptionPane.showMessageDialog(null, "No se han encontrado elementos", "Mensaje", JOptionPane.INFORMATION_MESSAGE);
        }
    }
}
