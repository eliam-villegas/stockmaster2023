...
public class Proveedores extends JPanel{
    ...
    public Proveedores(){
        ...
        SearchbarProveedor searchbar = new SearchbarProveedor(modelo);
        ...
        boton_guardar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(idtext.isEmpty()){
                    ...
                    dbc.ModificarProveedor(idTextField.getText(), nombreTextField.getText(), cargoTextField.getText());
                    SearchbarProveedor.Buscar("", modelo);
                }
            }
        });
        ...
        boton_guardar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(idtext.isEmpty()){
                    ...
                    dbc.EliminarProveedor(idTextField.getText());
                    SearchbarProveedor.Buscar("", modelo);
                }
            }
        });
