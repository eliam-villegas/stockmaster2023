...
public class Registro_abastecimiento extends JPanel {
    ...
    public Registro_abastecimiento() {
        ...
        ordenes_de_compra.setBorder(BorderFactory.createTitledBorder("Registros de abastecimiento"));

        String[] columnas = {"Numero de compra", "Fecha de compra", "Empleado comprador", "Proveedor"};
        modelo = new DefaultTableModel(null, columnas);

        SearchbarAbastecimiento searchbar_ord_compra = new SearchbarAbastecimiento(modelo);
        tabla_ordenes = create_table(modelo);
        ...
        JButton detalles_orden = new JButton("Detalles");
        ...
        detalles_orden.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                var tablaAbastecimiento = getTableFromScrollPane(tabla_ordenes);
                panelDetalles.tableModel.setRowCount(0);
                cardLayout.show(card_panel, "detalles");
                var dbc = new DatabaseConnection();
                var rows2 = dbc.ObtenerRegistroAbastecimientoDetalles(modelo.getValueAt(tablaAbastecimiento.getSelectedRow(), 0).toString());
                for (Object[] row : rows2) {
                     panelDetalles.agregarProducto(row[4].toString(),Integer.parseInt(row[5].toString()),Integer.parseInt(row[6].toString()));
                     panelDetalles.actualizarTotal(Integer.parseInt(row[7].toString()));
                     panelDetalles.actualizarNumeroCompra(row[0].toString());
                     panelDetalles.actualizarFecha(row[1].toString());
                     panelDetalles.actualizarProveedor(row[3].toString());
                     panelDetalles.actualizarEmpleadoComprador(row[2].toString());
        ...
        //boton crear orden
        JButton crear_orden = new JButton("Crear Registro");
        ...
        panel_seleccionar_proveedor(card_panel);
    ...
    private void panel_seleccionar_proveedor(JPanel card_panel) {
        ...
        vista_clientes.setBorder(BorderFactory.createTitledBorder("Proveedores asociados"));

        String[] columna_cliente = {"Rut", "Proveedor"};
        DefaultTableModel modelo_cliente = new DefaultTableModel(null, columna_cliente);
        SearchbarProveedorParaOrden searchbar_clientes = new SearchbarProveedorParaOrden(modelo_cliente);
    ...
    private void panel_crear_orden(JPanel card_Panel) {
        ...
        JLabel id_cliente = new JLabel("Rut proveedor:");
        ...
        JLabel nombre_cliente = new JLabel("Nombre proveedor:");
        ...
        // id de la orden
        JLabel id_orden = new JLabel("Numero Compra:");
        ...
        String[] columna_productos = {"Id", "Producto", "Stock"};
        ...
        JTextField precio_text = new JTextField("0");
        ((AbstractDocument) precio_text.getDocument()).setDocumentFilter(new NumberFilter());
        ...
        panel_crear_orden.add(precio, gridBagConstraints(2, 5, 1, 1, 0, 0, GridBagConstraints.HORIZONTAL, GridBagConstraints.NORTHWEST));
        ...
        panel_crear_orden.add(precio_text, gridBagConstraints(3, 5, 1, 1, 0, 0, GridBagConstraints.HORIZONTAL, GridBagConstraints.NORTHWEST));
        ...
        JButton generar_orden = new JButton("Generar Registro");
        ...
        guardar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (id_orden_text.getText().isEmpty()) {
                    JOptionPane.showMessageDialog(null, "Por favor ingrese un id para el registro", "Mensaje", JOptionPane.INFORMATION_MESSAGE);
                } else {
                    if (dbc.VerificarIDUnico_orden_de_compra(Integer.parseInt(id_orden_text.getText())) == true) {
                        ...
                        JOptionPane.showMessageDialog(null, "El numero de compra que a ingresado ya existe", "Mensaje", JOptionPane.INFORMATION_MESSAGE);
                    }
                }
            }
        });
